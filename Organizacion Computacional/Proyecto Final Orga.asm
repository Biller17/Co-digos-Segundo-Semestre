...
; Campus Santa Fe
;
; Proyecto de Organización computacional
; Pong
;
; Integrantes del equipo:
;  Adrián Biller                A01018940
;  Ángel Iván Téllez Cebada     A01022029
;  Arthur Alves Araujo Ferreira A01022593
;  Omar Sanseviero              A01021626
;  Rubén Cuadra                 A01019102
